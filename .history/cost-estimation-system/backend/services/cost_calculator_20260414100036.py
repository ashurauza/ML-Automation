...
class CostCalculator:
    ...
    def estimate_cycle_time(self, operations: List[str], dimensions: Dict[str, Any]) -> float:
        ...
        if total_time < 15:
            total_time = 30  # Increase to reasonable minimum
        ...
        if dimensions:
            ...
            for v in dimensions.values():
                ...
                if val and val > 0:
                    dimension_count += 1
            complexity_factor = 1.0 + (dimension_count * 0.05)
        
        final_cycle_time = cycle_time_hours * complexity_factor
        
        # Ensure minimum cycle time of 0.25 hours (15 minutes)
        if final_cycle_time < 0.25:
            final_cycle_time = 0.5  # 30 minutes minimum
        
        return final_cycle_time
